...
**Live Demo:** https://ai-research-assistant-l772.onrender.com/docs (Note: free-tier instance spins down after ~15 min of inactivity — first request may take 30-60s to wake up. Uploaded documents don't persist across redeploys due to ephemeral storage.)